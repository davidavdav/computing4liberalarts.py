...
\begin{answer}
  ...
  \item A speaker is chosen randomly from the available speakers. The early participants were available for more listeners to be choseon randomly, this explains the decreasing density with higher participant number. 
  \end{enumerate}
\end{answer}
